...
fn main() {
    ...
    let state = AppState { recorder: recorder.clone(), target_window: target_window.clone() };
    ...
    tauri::Builder::default()
      ...
      .invoke_handler(tauri::generate_handler![recording_start, recording_stop, latest_recording_path, transcribe_recording, insert_text])
